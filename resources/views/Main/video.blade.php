...
@section('content')
    ...
    <div id="content">
        <div>
            ...
            <ul id="portfolio-grid" class="filterable-portfolio thumbnails" data-cols="2cols">
                ...
                <li class="portfolio_item projects-category-2">
                    <div class="portfolio_item_holder">
                        <figure class="thumbnail thumbnail__portfolio">
                            <a class="image-wrap" href="images/projects/project-2.jpg" data-gal="prettyPhoto[slideshow]" title="اسلایدشو"><img src="images/projects/project-2.jpg" alt="اسلایدشو" /><span class="zoom-icon"></span></a>
                        </figure>
