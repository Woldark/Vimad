...
@section('content')
    ...
    <div id="content">
        <div>
            ...
            <ul id="portfolio-grid" class="filterable-portfolio thumbnails" data-cols="4cols">
...
@section('javascript')
    ...
    <script type="text/javascript" src="{{asset('/mian/js/jflickrfeed.js')}}"></script>
    <script type="text/javascript" src="{{asset('/mian/js/jquery.debouncedresize.js')}}"></script>
